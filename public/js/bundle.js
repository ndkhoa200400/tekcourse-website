...
exports.changePassword = exports.logout = exports.signup = exports.login = void 0;
...
var changePassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(passwordCurrent, password, passwordConfirm) {
    var res, _res4;
...
exports.checkOutCart = exports.buyCourse = void 0;
...
var buyCourse = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(courseSlugName) {
    var res, _res;
...
var changepassBtn = document.querySelector('.btn_change_pw'); // if (loginForm) {
...
if (courseSort) {
  var _loop = function _loop(index) {
    courseSort[index].addEventListener('click', function () {
      var sortAttribute = courseSort[index].getAttribute('data-sort-type');
  ...
  for (var index = 0; index < courseSort.length; index++) {
    _loop(index);
  }
}
